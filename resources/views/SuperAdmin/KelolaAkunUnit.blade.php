...
<body class="dash-body page-sa-akun-unit">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>••••••••</td>
              <td>
                <span class="status {{ ($item['status'] ?? 'active') === 'active' ? 'aktif' : 'nonaktif' }}">
                  {{ ($item['status'] ?? 'active') === 'active' ? 'Aktif' : 'Tidak Aktif' }}
                </span>
              </td>
              <td class="aksi">
                <button
  ...
  <div class="modal-backdrop" id="addModal">
    <div class="modal-card">
      ...
      <form
        action="{{ route('superadmin.kelola.akun.unit.store') }}"
        method="POST"
        class="modal-form">
    ...
    <div class="cf-panel" role="dialog" aria-modal="true">
      <div class="cf-card">
        ...
        <div class="cf-body">
          ...
          <div class="cf-desc">Akun Unit yang dihapus tidak dapat dikembalikan.</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.btn-edit').forEach(btn => {
        btn.addEventListener('click', () => {
          ...
          document.getElementById('edit_unit_kerja').value =
            btn.dataset.unitNama || '';
          ...
          if (editForm && id) editForm.action = "{{ url('super-admin/kelola-akun/unit') }}/" + id;
