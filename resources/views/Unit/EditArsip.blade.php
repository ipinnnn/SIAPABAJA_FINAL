...
<body class="dash-body">
  ...
  // ✅ dropdown ambil dari controller/master menu
  ...
  /**
  * DOKUMEN (SAMA PERSIS DENGAN TAMBAH PENGADAAN Unit)
  */
  $docSessions = [
  ...
  <div class="dash-wrap">
    {{-- SIDEBAR (SAMA PERSIS DENGAN TAMBAH PENGADAAN Unit) --}}
    ...
    <main class="dash-main">
      <header class="dash-header">
        ...
        <div class="tp-header-actions">
          <a href="{{ url('/unit/arsip') }}" class="tp-btn tp-btn-ghost tp-btn-fit">
              ...
              <div class="tp-grid">
                <div class="tp-field">
                  ...
                  <div class="tp-control">
                    <select name="tahun" class="tp-select tp-select-fixed" required>
  ...
  <style>
    ...
    .tp-acc-item.has-file .tp-acc-left i {
      color: #fff;
      opacity: .95;
    }

    .tp-acc-item.has-file .tp-acc-ic {
      color: #fff;
      opacity: .95;
    }
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const deleteExisting = async ({
        ...
        const target = DELETE_URL_TEMPLATE.replace(
          '__ID__',
          String(arsipId)
        );
      ...
      document.querySelectorAll('.tp-acc-item').forEach(item => {
        ...
        // ✅ remove existing -> ajax delete (DELETE)
