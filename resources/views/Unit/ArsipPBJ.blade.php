...
<div class="sidebar-drawer-backdrop" id="sidebarBackdrop"></div>
    ...
    <style>
        ...
        /* =========================================================
   MOBILE TOPBAR & DRAWER — Unit ArsipPBJ
========================================================= */
.mob-topbar {
  display: none;
  align-items: center;
...
@media (max-width: 768px) {
  ...
  .ap-header h1 { font-size: 20px !important; }

  .ap-header-right { width: 100%; }
  ...
  .dt-info-grid { grid-template-columns: 1fr !important; }
  .dt-budget-grid { grid-template-columns: 1fr 1fr !important; }
  ...
  .hist-tbl-head .hist-col:nth-child(3),
  .hist-tbl-head .hist-col:nth-child(4),
  .hist-tbl-row .hist-col:nth-child(3),
  .hist-tbl-row .hist-col:nth-child(4) {
    display: none !important;
  }
}
...
@media (max-width: 900px) {
  ...
  .ap-tbl-row:hover { background: #f8fafc !important; }
