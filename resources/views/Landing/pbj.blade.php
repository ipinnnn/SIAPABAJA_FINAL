...
Object.keys(docs).forEach(grp => {
  ...
  arr.forEach(doc => {
    ...
    const labelDisplay = label.replace(/_/g, ' ').replace(/\b\w/g, c => c.toUpperCase());
    ...
    card.innerHTML = `
      ...
      <a class="dt-doc-act" href="${toViewerUrl(rawUrl)}" target="_blank" rel="noopener" title="Lihat Dokumen">
        <i class="bi bi-eye"></i>
      </a>
    `;
